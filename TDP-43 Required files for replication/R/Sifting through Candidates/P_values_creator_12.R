...
#Select Columns (In this case the generation time columns are selected)
a <- 6
b <- 7
c <- 8
...
gtkcl <- merge(kcl,pk,by.x="Identifier",by.y="Identifier")
gtnacl <- merge(nacl,pn,by.x="Identifier",by.y="Identifier")